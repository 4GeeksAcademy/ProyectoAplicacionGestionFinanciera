    ...
    <div className="mb-4 position-relative">
        ...
        <div className="input-group">
            ...
            <input
                ...
                value={value}
                onChange={onChange}
                className="form-control form-control-sm border-bottom border-primary shadow-none"
    ...
    <div className="mb-4 position-relative">
        ...
        <div className="input-group">
            ...
            <select
                ...
                value={value}
                onChange={onChange}
                className="form-select form-select-sm border-bottom border-primary shadow-none"
                required={required}
                style={{
                    backgroundColor: "var(--input-background-color)",
                    color: "var(--text-color)"
